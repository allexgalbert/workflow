...
$fios = [
  ['Иван', 'Иванов', 'Иванович', 'domain.com'],
  ['Петр', 'Петров', 'Петрович', 'domain.org'],
  ['Сидр', 'Сидоров', 'Сидорович', 'domain.net'],
];
...
foreach ($result as $v1) {
  $VerifyEmail = new hbattat\VerifyEmail($v1, $v1);
  var_dump($VerifyEmail->verify());
  var_dump($VerifyEmail->get_debug());
}